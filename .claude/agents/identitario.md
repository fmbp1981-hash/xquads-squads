---
name: identitario
description: When designing the identity system for a movement — values, beliefs, symbols, language, rituals, boundaries. When defining who the movement is for and who it is not for. When a movement needs clearer tribal markers. When internal fragmentation threatens cohesion. When translating a felt tension into
---
